...
def plot_miami2( 
    ...
    if mqq_args1 is None:
        mqq_args1 = {}
    if mqq_args2 is None:
        mqq_args2 = {}
    ...
    #merged_sumstats, chrom_df = _quick_assign_i(merged_sumstats)
    ...
    fig, (ax1, ax5) = plt.subplots(2, 1, gridspec_kw={'height_ratios': [1, 1]},**figargs)
...
#
    ...
    #        
#####################################################################################################################
# Ad#d Annotation to manhattan plot #######################################################
