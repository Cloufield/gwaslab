...
"""
    ...
    meta_info = {
        ...
        "Genome build": self.meta.get("gwaslab", {}).get("genome_build", "Unknown"),
        "Genome assembly": self.meta.get("genome_assembly", "Unknown"),
        "Build confidence": self.meta.get("gwaslab", {}).get("genome_build_confidence", "unknown"),
        "Build source": self.meta.get("gwaslab", {}).get("genome_build_source", "Unknown"),
        "QC and Harmonization": self.check_sumstats_qc_status(),
        "Metadata validation": self.validate_meta(),
    }
