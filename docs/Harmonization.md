...
|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| `.check_ref()`         | `ref_path`                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Check alignment with a reference genome FASTA file                                                                                |
| `.assign_rsid()`       | `ref_rsid_tsv`,<br /> `ref_rsid_vcf`,<br /> `threads=1`, <br />`chunksize=5000000`, <br />`overwrite="empty"`                                                                                                                                                                                                                                                                                                                                                                       | Annotate **rsID** using a reference tabular file or VCF/BCF file                                                                      |
